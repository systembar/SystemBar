...
<div class="row">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="agregar.php" method="post">
                            <input type="number" class="form-control" name="cantidad" style="width:90px; display:inline; background: #e0e0e0; border-radius:10px; height: 30px">
    ...
    <div class="container">
        <!-- Modal Trigger -->
        <a class="waves-effect waves-light modal-trigger registrar" href="#demo-modal"  style="margin-top:0%;margin-left:24%;">Carrito <span class="lnr lnr-cart" style="font-size:15px;"></span><?php echo count($_SESSION["carrito"]);?></a>

        <!-- Modal Structure -->

        <div id="demo-modal" class="modal" style="background-color: white;">
           
            <h3 style="font-size: 40px; margin-top:2%; margin-left:3%;color:rgba(1, 1, 1, 0.37)">Productos en el carrito</h3>
...
echo '<table class="striped" style="width:80%; float:left; margin-left:3%; ">';
    ...
    $i++;
        ...
        echo '<tr>
            <td>
                ...
                <input type="number" class"campo" name="descuento" style="width:80%; display:inline; background: #e0e0e0; border-radius:10px; height: 30px">
                <input type="submit" class="registrar" style="margin-top:8%;margin-left:84%;" value="Comprar">
                </form>
            </td>
        </tr>
