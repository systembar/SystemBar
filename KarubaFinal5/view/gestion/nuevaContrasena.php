...
<body class="login">
  ...
  <div id="formContent">
    <!-- Tabs Titles -->
    <h2 class="active"> <a href="#" style="color:black">Nueva Contraseña</a> </h2>
    ...
    <form action="" method="POST">
      <input type="text" id="usuario" class="fadeIn " name="user" placeholder="Contraseña">
      <input type="password" id="pass" class="fadeIn" name="pass" placeholder="Confirmar Contraseña">
