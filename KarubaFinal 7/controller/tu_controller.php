...
class tu_Controller extends Conexion
{
	...
	public function insertar(TipoUsuario $TipoUsuario )
	{
		$insertar="INSERT INTO tbl_tipo_usuario (id_tipoUsuario,nombre) values (?,?)";
		try {
			$this->conexion->prepare($insertar)->execute(array(
				$TipoUsuario->__GET('id_tipoUsuario'),
				$TipoUsuario->__GET('nombre')
			));
